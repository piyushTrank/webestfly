        ...
        >
          <View style={styles.section}>
            ...
            <Text style={styles.txt}>
              ...
              As per our conversation and as agreed, we have booked a new
            ...
            <Text style={styles.txt}>
              There will be {data.cardStatementCharge2 !== "" ? "2" : "1"}{" "}
              charges appearing on your card statement of{" "}
              <Text style={styles.boldTxt}>
                ${data.cardStatementCharge1} USD ({data.airlinesName}){" "}
                {data.cardStatementCharge2 !== ""
                  ? `and $${data.cardStatementCharge2} USD`
                  : ""}
              </Text>{" "}
              as <Text style={styles.boldTxt}>({data.bookedThrough})</Text>.
            </Text>
            <Text style={styles.txt}>
              We have booked your reservation as you are paying through{" "}
